export const ENDPOINTS = {
    ...
    GET_STATUS_CATEGORY_PENDING: '/HRMBackendTest/assest/category?status=PENDING',
    ...
    GET_APPROVER_ASSET_REQUEST_LIST: '/HRMBackendTest/assest/v2/approverAssestRequestList?page=0&size=10',
